public class Story {
   ...
   public static String e5Story() {
      description = "You stand at the entrance to the town, your town, where you grew up with your friends and family, all terrorized by the Count and his thralls. His reign of terror over the land ends today, as you set out on your journey to Castle Sinistraad to finally slay the great vampire lord once and for all.";
      return description;
   }
