public class Story {
   ...
   Some of them have logic to determine which description for each location
   ...
   // Create class variable description to be used as a temp value and modified before it is returned
   private static String description;

   public static String e5Story() {
      description = "You stand at the entrance to the town, your town, where you grew up with your friends and family, all terrorized by the Count and his thralls." + "\n" +
   ...
   public static String farmerStory() {
      return "\n\nOLD REMRAF: “Child! I heard word of your plan to journey onward amd finally slay that evil spirit cursing our land, but I fear you are not yet ready for such a journey!" + "\n" +
   ...
   public static String e4Story() {
      description = "Trudging through the tall grass of the field, you see the entrance to the Duskwood Forest, beyond which lies the grounds of Castle Sinistraad." + "\n" +
   ...
   public static String d5Story() {
      ...
      "As you continue, the shrubbery either side of the path becomes even more gnarled and poorly maintained, forcing you to inch along sideways as the tangle of plants older than yourself stop you from continuing any further."+ "\n" +
      "You must turn around and find more travelled paths.";
   }

   public static String d3Story() {
      return "You continue further into the forest. To the north you can see the forest start to thin out - you can almost smell the fresher air ahead." + "\n" +
   ...
   public static String c2Story() { // TODO Story edits from here.
      return "As you breach the darkness of the forest into the clearing, you feel the warmth of the sun on your skin and look around the clearing." + "\n" +
      "There doesn’t seem to be any other paths out of the clearings, but upon a quick scan of the tree line you see an old figure, draped in various cloths obscuring their figure, bug-eyed goggles peeking out from their moss covered cowl." + "\n" +
   ...
   public static String a3Story() {
      ...
      "Perched above the gargantuan entrance of the Castle sits a Gargoyle Statue, unmoving. You see the key fastened to a collar on the statues neck, you’re gonna have to climb to get it.";
   }
   ...
   public static String a2Story() {
      ...
      "You can hear a faint, sing-song humming and the clanking of a hammer on metal in a room deeper in the castle, the intricate path of the tiled marble floors leading you deeper into the castle.";
   }
   ...
   public static String b3Story() {
      ...
      "The smell of rotten fruits hit your nose and cause you to wince as you see the thick syrup of old wine casks leak over the floor, spilling spoiled and forgotten wine making the floor sticky and red." + "\n" +
   ...
   public static String b1Story() {
      ...
      "The key you got from the Stoneskin Gargoyle would never fit. To the west you hear the pleasant humming and clanking with the hammer.";
   }
   ...
   public static String c1Story() {
      ...
      "The pedestal almost glows on its own, dancing in the candlelight, jewelled detailing scattering it everywhere.";
   }
   
   public static String altarSuccessStory() {
      return "Walking up to the altar, you notice a circular groove in the surface of the altar platform." + "\n" +
      "You reach into your bag and extract the matching goblet, brimming with the mystical tears from the ghost of the Lost Maiden from the lake." + "\n" +
      "Gently placing the goblet into the circle, it fits with a satisfying clunk, before exploding in a flourish of mutlicoloured light." + "\n" +
   ...
   public static String altarFailStory() {
      return "Approaching the altar you notice a circular groove in the surface of the altar, you trace it with your finger, press it, nothing." + "\n" +
   ...
   public static String e1Story() {
      return "You slam the door open, brandishing your sword as you are met with a man, dressed in an all black suit, with slicked back hair and pale, translucent skin and gaunt eyes, reading out of a tomb. ";
   }
