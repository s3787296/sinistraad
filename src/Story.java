public class Story {
     ...
     public static String E4Text(){
         return"Trudging through the tall grass of the field, you see the entrance to the Duskwood forest, beyond witch lies the grounds of Castle Sinistraad. As you head towards the mouth of the forest you are hailed by Old Remraf, the eccentric farmer who owns the lands surrounding the town. To the west is the forest lining, the old town back down south, and to the north is the twisted caverns.";
  
      }
      public static String FarmerText(){
         return"Child! I heard word of your plan to journey onward to finally slay that evil spirit cursing our land, but I fear you are just not ready for such a journey! Beyond this you’ll need a map! I happen to have one, but to get it you’ll have to prove yourself! Say what, if you go to the Twisted Caverns up North, and slay the Arachnid Queen, it’ll prove your strength!";
  
      }
      public static String E3Text(){
         return"You hesitantly inch through the Twisted Caverns, hearing the scuttling of many legs emanate from deeper in the tunnels.  As you head deeper your surroundings get illuminated by the sickly green hue of glow worms dotting the cave roof. As you descend even further you hear an almost alien chittering sound. Creepy stuff. To exit the cave you must head back the way you came. Or you can descend and face whatever may lay deeper.";
  
      }
      public static String BeforeArachnidText(){
         return"As you decide to bravely travel deeper you feel spider webs brush against your head and gets snagged, and many baby spiders scurry and squish under your heavy footfalls. You eventually are facing a large web you could throw yourself at without breaking and watch as it vibrates. As you look up 8 sharp eyes glow at you out of the darkness,  the arachnid matriarchs monstrous form scuttle down the man sized web to meet you where you stand.";
  
      }
      public static String AfterArachnidText(){
         return"At last, the  Arachnid Matriarch lays defeated before you, oozing sickly blue fluid from its many wounds you inflicted, you feel the weight of the journey ahead of you. You must now return to Old Remraf, and get his blessings for the journey ahead. The map wont hurt either.";
  
      }
      public static String FarmerReturnText(){
         return"Ahoy, child! I can see by your bloody blade that you have defeated that nasty creature that’s been killing our beautiful cows and webbing up the crops! You’ve done the town a great service, and I can see that you truly are ready to conquer the forest and slay that evil Count! Take this map so that you may not get lost in the duskwood forest, some people say that it does weird stuff to less prepared adventurers after al!";
  
      }
      public static String D4Text(){
         return"You leave the safety of the towns outer borders and step hesitantly past the forest lining, the sunlight muffled by the broad trees’ dense canopy, you can feel the air heavy with moisture and a sense of impending doom. The only direction that doesn’t seem to lead to more forest is east, back into the field, but you have a job to do.";
  
      }
      public static String D5Text(){
          return"You wander aimlessly along one of the faded walking paths, as you continue the shrubbery either side of the path more gnarled, overgrown and poorly maintained, forcing  you to inch along sideways as vines bushes and trees older than you are eventually stop you from moving all together. At an impasse, you understand that you must head back north, to more travelled paths.";
   
       }
       public static String D3Text(){
          return"You continue deeper into the forest. To the north you can see the forests dense and bearing nature slowly thin out, you can almost smell the fresher air ahead. To the east lies more forest. To the South also lies more forest.";
   
       }
       public static String D2Text(){
          return"Breaching into a clearing, the ground gives way to a large empty lake. The blue, almost glowing water is almost enticing you to take a dip, but your driven nature and fear of the unknown outweighs the almost gravitational pull of the blue depths. As you scan the shore of the lake, a maiden,a dripping wet corpse with waterlogged flesh lies at the shoreline, reaching out at the forest. You could investigate the mysterious corpse, or go back south into the forest again.";
   
       }
       public static String BeforeMaidenText(){
          return"As you approach the bloated corpse, it suddenly stirs back to life, its waterlogged torso rising on distended bruised limbs, its hollow grey eyes stare menacingly at you. You could probably outrun its influence, or face it if you dare.";
   
       }
       public static String AfterMaidenText(){
          return"After a long battle, you fall to your knees exhausted, the sliced corpse lays before you, a ghostly spirit rises from her defeated corpse and mopes back to the lakes waterline and slumps down beginning to sob uncontrollably. A heavy flow of glowing tears pour from her face through her hands and into the lake.";
   
       }
       public static String TearsFailText(){
          return"As the tears continue to flow and glimmer as they dilute into the lake, you wish you could take some with you.";
   
       }
       public static String TearsSucceedText(){
         return"You hesitantly reach the golden bejewelled flask out into the transparent form of the lady of the lake, intercepting her steady flow of mystical tears, and fill the goblet to the brim with the mystical tears.";
  
      }
      public static String C3Text(){
          return"You continue travelling through the deadly forest, the faded walking path overgrown with roots winding around rocks and trees, to the north you notice another clearing in the forest. The only other way you could head now is back east into more forest for now.";
   
       }
       public static String C2Text(){
          return"As you breach the darkness of the forest into the clearing you feel the warmth of the sun on your skin and look around the overgrown clearing. There doesn’t seem to be any other paths out of the clearings, but upon a quick scan of the tree line you see an old figure, draped in various cloths obscuring their figure, bug eyed goggles peeking out from their moss covered cowl, you have no clue how long they’ve been posted at this spot, but you should probably investigate.";
   
       }
       public static String NostramusStartText(){
          return"As you step closer, you see the obscured head of the figure turn quickly to face you before the figure jumps up in excitement “Aha! Yes! Finally, another adventurer! Its been so long! Quick child, have a look at my wares! Anything a young adventurer will need to survive the forest!” before they whip their cloak open to reveal various potions and a glowing gold flask encrusted in jewels and inscribed in some script lost to time.";
   
       }
       public static String NostramusGobletText(){
      ...
      public static String BeforeWerewolvesText(){
      ...
      public static String AfterWerewolvesText(){
      ...
      public static String WolfArmourText(){
      ...
      public static String BeforeGargoyleText(){
      ...
      public static String AfterGargoyleText(){
      ...
      public static String BeforeFuegoText(){
      ...
      public static String AfterFuegoText(){
      ...
      public static String PickupSwordText(){
      ...
      public static String AltarSuccessText(){
      ...
      public static String AltarFailText(){
      ...
      public static String BeforeEripmavText(){
      ...
      public static String GoodEndingText(){
      ...
      public static String GreatEndingText(){
