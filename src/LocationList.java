...
public class LocationList {
    ...
    public static void createLocations() {
        ...
        //
        Location a1Location = new Location("A1", "CASTLE ARMOURY", Story.a1Story());
        aList.add(a1Location);
        //
        Location a2Location = new Location("A2", "CASTLE INTERIOR", Story.a2Story());
        aList.add(a2Location);
        //
        Location a3Location = new Location("A3", "CASTLE COURTYARD", Story.a3Story());
        aList.add(a3Location);
        //
        Location a4Location = new Location("A4", "DUSKWOOD FOREST", Story.a4Story());
        ...
        //
        Location b1Location = new Location("B1", "CASTLE INTERIOR", Story.b1Story());
        bList.add(b1Location);
        //
        Location b2Location = new Location("B2", "CASTLE INTERIOR", Story.b2Story());
        bList.add(b2Location);
        //
        Location b3Location = new Location("B3", "CASTLE INTERIOR", Story.b3Story());
        bList.add(b3Location);
        //
        Location b4lLocation = new Location("B4", "DUSKWOOD FOREST", Story.b4Story());
        bList.add(b4lLocation);
        //
        Location b5Location = new Location("B5", "DUSKWOOD FOREST", Story.b5Story());
        bList.add(b5Location);
        //
        cList.add(nullLocation);
        //
        Location c1Location = new Location("C1", "CASTLE CATHEDRAL", Story.c1Story());
        cList.add(c1Location);
        //
        Location c2Location = new Location("C2", "DUSKWOOD CLEARING", Story.c2Story());
        cList.add(c2Location);
        //
        Location c3Location = new Location("C3", "DUSKWOOD FOREST", Story.c3Story());
        cList.add(c3Location);
        //
        Location c4Location = new Location("C4", "DUSKWOOD FOREST", Story.c4Story());
        cList.add(c4Location);
        //
        Location c5Location = new Location("C5", "DUSKWOOD DEN", Story.c5Story());
        cList.add(c5Location);
        //
        dList.add(nullLocation);
        //
        Location d1Location = new Location("D1", "CASTLE CHAMBERS", Story.d1Story());
        dList.add(d1Location);
        //
        Location d2Location = new Location("D2", "MYSTIC LAKE", Story.d2Story());
        dList.add(d2Location);
        //
        Location d3Location = new Location("D3", "DUSKWOOD FOREST", Story.d3Story());
        dList.add(d3Location);
        //
        Location d4Location = new Location("D4", "DUSKWOOD FOREST", Story.d4Story());
        dList.add(d4Location);
        //
        Location d5Location = new Location("D5", "DUSKWOOD FOREST", Story.d5Story());
        dList.add(d5Location);
        //
        eList.add(nullLocation);
        //
        Location e1Location = new Location("E1", "THRONE ROOM", Story.e1Story());
        eList.add(e1Location);
        //
        Location e2Location = new Location("E2", "NOT ACCESSIBLE", "Something has gone wrong.");
        eList.add(e2Location);
        //
        Location e3Location = new Location("E3", "TWISTED CAVE", Story.e3Story());
